...
// --> IMPORTANTE <--
// SE MAIS PRA FRENTE QUISER ADICIONAR OS ID NO CURRICULUM (SCHOOL, CLASS, ETC)
// É SÓ ADICIONAR DIRETAMENTE NA FUNÇÃO DE CRIAÇÃO DO DADO NO FIREBASE, USANDO
// OS DADOS EXISTENTES NO dataArrayType
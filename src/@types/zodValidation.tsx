...
export const loginEmailAndPasswordValidationSchema = z.object({
  email: z
    .string()
    .min(1, { message: `Por favor, preencha o campo "E-mail"` })
    .email({ message: "E-mail inválido" }),
  password: z.string().min(1, { message: `Por favor, digite sua senha` }),
});

// SIGNUP VALIDATION SCHEMA
export const signUpEmailAndPasswordValidationSchema = z
  .object({
    ...
    document: z
      .string()
      .min(1, { message: `Por favor, preencha o campo "CPF"` }),
    password: z.string().min(1, { message: `Por favor, digite sua senha` }),
    confirmPassword: z
      .string()
      .min(1, { message: `Por favor, confirme a sua senha` }),
  })
...
export const createStudentValidationSchema = z.object({
  ...
  schoolYears: z
    .string()
    .min(1, { message: `Por favor, selecione o Ano Escolar` }),
  schoolYearsComplement: z
    .string()
    .min(1, { message: `Por favor, selecione a Turma` }),
  parentOne: z.object({
    name: z
      .string()
      .min(1, { message: `Por favor, preencha o campo "Nome Filiação 1"` }),
    phone: z.object({
      ddd: z
        .string()
        .min(2, {
          message: `Por favor, escolha um DDD para o Telefone de contato Filiação 1`,
        }),
      number: z
        .string()
        .min(4, {
          message: `Por favor, insira corretamente o Telefone de contato Filiação 1`,
        }),
    }),
    email: z
      .string()
      .min(1, { message: `Por favor, preencha o campo "E-mail Filiação 1"` })
      .email({ message: "E-mail Filiação 1 inválido" }),
  }),
  parentTwo: z.object({
    name: z
      .string()
      .min(1, { message: `Por favor, preencha o campo "Nome Filiação 2"` })
      .optional()
      .or(z.literal("")),
    phone: z.object({
      ddd: z
        .string()
        .min(2, {
          message: `Por favor, escolha um DDD para o Telefone de contato Filiação 2`,
        })
        .optional()
        .or(z.literal("")),
      number: z
        .string()
        .min(4, {
          message: `Por favor, insira corretamente o Telefone de contato Filiação 2`,
        })
        .optional()
        .or(z.literal("")),
    }),
    email: z
      .string()
      .min(1, { message: `Por favor, preencha o campo "E-mail Filiação 2"` })
      .email({ message: "E-mail Filiação 2 inválido" }),
  }),

  // Section 2: Student Course and Family Data | Prices
  // familyAtSchoolId: z.string().optional().or(z.literal('')),
  studentFamilyAtSchool: z.string().array(),
  ...
  customDiscountValue: z
    .string()
    .min(1, {
      message:
        "Ocorreu um erro ao preencher o valor de porcentagem personalizada de desconto. Contate o suporte.",
    }),
  ...
  paymentDay: z
    .string()
    .min(1, { message: "Por favor, informe o melhor dia para pagamento" })
    .or(z.literal("")),
  ...
  financialResponsible: z.object({
    name: z
      .string()
      .min(1, {
        message: `Por favor, preencha o campo "Nome" do Responsável Financeiro`,
      }),
    document: z
      .string()
      .min(1, {
        message: `Por favor, preencha o campo "CPF" do Responsável Financeiro`,
      }),
    email: z
      .string()
      .min(1, {
        message: `Por favor, preencha o campo "E-mail" do Responsável Financeiro`,
      })
      .email({ message: "E-mail do Responsável Financeiro inválido" }),
    address: z.object({
      street: z
        .string()
        .min(1, {
          message: `Por favor, preencha o campo "CEP" para buscar o endereço completo, ou insira manualmente`,
        }),
      number: z
        .string()
        .min(1, { message: `Por favor, preencha o campo "Número"` }),
      complement: z
        .string()
        .min(1, {
          message: `Por favor, preencha o campo "CEP" para buscar o endereço completo, ou insira manualmente`,
    ...
    phone: z.object({
      ddd: z
        .string()
        .min(2, {
          message: `Por favor, escolha um DDD para o Telefone do Responsável Financeiro`,
        }),
      number: z
        .string()
        .min(4, {
          message: `Por favor, insira corretamente o Telefone do Responsável Financeiro`,
        }),
    }),
...
export const createClassValidationSchema = z.object({
  ...
  schoolStageId: z
    .string()
    .min(1, { message: `Por favor, escolha a Etapa Escolar` }),
  // confirmInsert: z.boolean()
});
...
export const createCourseValidationSchema = z.object({
  name: z
    .string()
    .min(1, { message: `Por favor, preencha o campo "Modalidade"` }),
  priceUnit: z
    .number()
    .min(1, { message: `Por favor, preencha o campo "Preço da Aula Avulsa"` }),
  priceBundle: z
    .number()
    .min(1, {
      message: `Por favor, preencha o campo "Preço do Pacote de Aulas"`,
    }),
  bundleDays: z
    .number()
    .min(1, {
      message: `Por favor, preencha o campo "Número de aulas no Pacote de Aulas"`,
    }),
  // confirmInsert: z.boolean()
});
...
export const createClassDaysValidationSchema = z.object({
  name: z
    .string()
    .min(1, { message: `Por favor, preencha o campo "Identificador"` }),
  sunday: z.boolean(),
  monday: z.boolean(),
  tuesday: z.boolean(),
  wednesday: z.boolean(),
...
export const createScheduleValidationSchema = z.object({
  ...
  transitionStart: z
    .string()
    .min(1, { message: `Por favor, preencha o campo "Início da Transição"` }),
  transitionEnd: z
    .string()
    .min(1, { message: `Por favor, preencha o campo "Fim da Transição"` }),
  classStart: z
    .string()
    .min(1, { message: `Por favor, preencha o campo "Início da Aula"` }),
  classEnd: z
    .string()
    .min(1, { message: `Por favor, preencha o campo "Fim da Aula"` }),
  exit: z.string().min(1, { message: `Por favor, preencha o campo "Saída"` }),
  schoolId: z
    .string()
    .min(1, { message: `Por favor, preencha o campo "Escola"` }),
  // confirmInsert: z.boolean()
});
...
export const createTeacherValidationSchema = z.object({
  ...
  phone: z.object({
    ddd: z
      .string()
      .min(2, {
        message: `Por favor, escolha um DDD para o Telefone de contato`,
      })
      .or(z.literal("")),
    number: z
      .string()
      .min(9, {
        message: `Por favor, insira corretamente o Telefone de contato`,
      })
      .or(z.literal("")),
  }),
...
export const createCurriculumValidationSchema = z.object({
  ...
  schoolClassIds: z.string().array(),
  schoolCourseId: z
    .string()
    .min(1, { message: `Por favor, escolha a Modalade` }),
  scheduleId: z.string().min(1, { message: `Por favor, escolha o Horário` }),
  classDayId: z
    .string()
    .min(1, { message: `Por favor, escolha os Dias de Aula` }),
  teacherId: z.string().min(1, { message: `Por favor, escolha o Professor` }),
  placesAvailable: z
    .number()
    .nonnegative({
      message: "Não é possível escolher um número negativo de vagas",
    }),
  // confirmInsert: z.boolean(),
});
...
export const deleteClassValidationSchema = z.object({
  ...
  schoolStageId: z
    .string()
    .min(1, { message: `Por favor, selecione a Etapa Escolar` }),
  schoolClassId: z
    .string()
    .min(1, { message: `Por favor, selecione a Faixa Escolar` }),
  schoolClassName: z
    .string()
    .min(1, { message: `Por favor, selecione a Faixa Escolar` }),
});
...
export const deleteStudentValidationSchema = z.object({
  ...
  curriculumId: z
    .string()
    .min(1, { message: `Por favor, selecione a Modalidade` }),
  ...
  studentType: z
    .literal("")
    .or(
      z.literal("enrolled").or(z.literal("experimental")).or(z.literal("all"))
    ),
});
...
export const deleteSchoolCourseValidationSchema = z.object({
  ...
  schoolCourseId: z
    .string()
    .min(1, { message: `Por favor, selecione o Curso` }),
  schoolCourseName: z
    .string()
    .min(1, { message: `Por favor, selecione o Curso` }),
  priceUnit: z
...
export const deleteClassDaysValidationSchema = z.object({
  classDayId: z
    .string()
    .min(1, { message: `Por favor, selecione Dia de Aula` }),
});
...
export const deleteScheduleValidationSchema = z.object({
  ...
  scheduleId: z
    .string()
    .min(1, { message: `Por favor, selecione o Identificador` }),
  scheduleName: z
    .string()
    .min(1, { message: `Por favor, selecione o Identificador` }),
});
...
export const editSchoolClassValidationSchema = z.object({
  name: z
    .string()
    .min(1, { message: `Por favor, digite o nome da Faixa Escolar` }),
  schoolStageId: z
    .string()
    .min(1, { message: `Por favor, escolha a Etapa Escolar` }),
});
...
export const editSchoolCourseValidationSchema = z.object({
  name: z
    .string()
    .min(1, { message: `Por favor, preencha o nome da Modalidade` }),
  priceUnit: z
    .number()
    .min(1, { message: `Por favor, preencha o campo "Preço da Aula Avulsa"` }),
  priceBundle: z
...
export const editCurriculumValidationSchema = z.object({
  ...
  schoolCourseId: z
    .string()
    .min(1, { message: `Por favor, escolha a Modalidade` }),
  scheduleId: z.string().min(1, { message: `Por favor, escolha o horário` }),
  classDayId: z
    .string()
    .min(1, { message: `Por favor, escolha os dias de aula` }),
...
export const editSystemConstantsValidationSchema = z.object({
  ...
  enrolmentFee: z
    .number()
    .min(1, { message: `Por favor, insira o valor da matrícula` }),
  enrolmentFeeDiscount: z
    .number()
    .min(1, { message: `Por favor, insira o valor da matrícula com desconto` }),
  employeeDiscountValue: z
    .number()
    .min(1, {
      message: `Por favor, insira o valor do desconto para funcionários`,
    }),
  familyDiscountValue: z
    .number()
    .min(1, { message: `Por favor, insira o valor do desconto familiar` }),
  standardPaymentDay: z
    .string()
    .min(1, { message: `Por favor, insira o dia padrão para pagamento` }),
  secondCourseDiscountValue: z
    .number()
    .min(1, {
      message: `Por favor, insira o valor do desconto para segundo curso`,
    }),
  ...
  customerFullName: z
    .string()
    .min(1, {
      message: `Por favor, escolha insira o nome completo da Empresa`,
    }),
  customerShortName: z
    .string()
    .min(1, {
      message: `Por favor, escolha insira o nome abreviado da Empresa`,
    }),
  year: z
    .string()
    .min(1, { message: `Por favor, escolha o ano para os valores` }),
});
...
export const searchCurriculumValidationSchema = z.object({
  ...
  schoolClassId: z
    .string()
    .min(1, { message: `Por favor, escolha a Faixa Escolar` }),
  schoolCourseId: z
    .string()
    .min(1, { message: `Por favor, escolha a Modalidade` }),
});
